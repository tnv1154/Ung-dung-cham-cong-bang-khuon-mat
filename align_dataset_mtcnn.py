...
# Remove future imports as they're not needed in Python 3.10
import sys
import os
import argparse
...
def main(args):
    ...
    # Update TensorFlow 2.x approach to disable eager execution
    tf.compat.v1.disable_eager_execution()
    
    with tf.compat.v1.Graph().as_default():
        # For TensorFlow 2.x, use ConfigProto from compat.v1
